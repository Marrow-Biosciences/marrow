      ...
      spec {
        ...
        container {
          ...
          args = [
            ...
            "--meta-address", "http://${kubernetes_service_v1.risingwave_meta.metadata[0].name}:5690",
...
resource "kubernetes_service_v1" "risingwave_compute" {
  ...
  spec {
    ...
    port {
      name        = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[0].name
      port        = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[0].container_port
      target_port = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[0].name
    }
    port {
      name        = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[1].name
      port        = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[1].container_port
      target_port = kubernetes_deployment_v1.risingwave_compute.spec[0].template[0].spec[0].container[0].port[1].name
    }
    type = "ClusterIP"
  }
}
